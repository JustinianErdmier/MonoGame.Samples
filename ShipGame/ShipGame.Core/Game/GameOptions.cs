...
public class GameOptions
{
    ...
    public static Vector3 CameraViewOffset = new(x: 0, y: -10, z: 0);

    // offset for camera in 3rd person mode
    public static Vector3 CameraOffset = new(x: 0, y: 50, z: 125);

    // offset for camera target in 3rd person mode
    public static Vector3 CameraTargetOffset = new(x: 0, y: 0, z: -50);
    ...
    public static Vector3 MissileTrailOffset = new(x: 0, y: 0, z: -10);
