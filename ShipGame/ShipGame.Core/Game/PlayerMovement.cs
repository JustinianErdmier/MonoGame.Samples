...
public class PlayerMovement
{
    ...
    /// <summary>Create a new player movement object for handling player motion</summary>
    ...
    /// <summary>Get the current postion and rotation as a matrix</summary>
    ...
    /// <summary>Get the normalized velocity</summary>
    public float VelocityFactor => velocity.Length() / maxVelocity;

    /// <summary>Get/Set the velocity vector transformed to world space</summary>
    public Vector3 WorldVelocity
    {
        // transform local velocity to world space
        get => velocity.X * rotation.Right + velocity.Y * rotation.Up + velocity.Z * rotation.Forward;
    ...
    /// <summary>Resets the position and rotation of the player and zero forces</summary>
    ...
    /// <summary>Process movement input</summary>
    ...
    public void Update(float elapsedTime)
    {
            ...
            && force.X < 0.001f)
        {
            if (velocity.X > 0)
            {
                velocity.X = Math.Max(val1: 0.0f, velocity.X - dampingForce * elapsedTime);
            }
            else
            {
                velocity.X = Math.Min(val1: 0.0f, velocity.X + dampingForce * elapsedTime);
            }
        }
            ...
            && force.Y < 0.001f)
        {
            if (velocity.Y > 0)
            {
                velocity.Y = Math.Max(val1: 0.0f, velocity.Y - dampingForce * elapsedTime);
            }
            else
            {
                velocity.Y = Math.Min(val1: 0.0f, velocity.Y + dampingForce * elapsedTime);
            }
        }
            ...
            && force.Z < 0.001f)
        {
            if (velocity.Z > 0)
            {
                velocity.Z = Math.Max(val1: 0.0f, velocity.Z - dampingForce * elapsedTime);
            }
            else
            {
                velocity.Z = Math.Min(val1: 0.0f, velocity.Z + dampingForce * elapsedTime);
            }
        }
        ...
        // apply rot damping
        if (rotationForce.X    > -0.001f
            && rotationForce.X < 0.001f)
        {
            if (rotationVelocityAxis.X > 0)
            {
                rotationVelocityAxis.X = Math.Max(val1: 0.0f,
                                                  rotationVelocityAxis.X - dampingRotationForce * elapsedTime);
            }
            else
            {
                rotationVelocityAxis.X = Math.Min(val1: 0.0f,
                                                  rotationVelocityAxis.X + dampingRotationForce * elapsedTime);
            }
        }

        if (rotationForce.Y    > -0.001f
            && rotationForce.Y < 0.001f)
        {
            if (rotationVelocityAxis.Y > 0)
            {
                rotationVelocityAxis.Y = Math.Max(val1: 0.0f,
                                                  rotationVelocityAxis.Y - dampingRotationForce * elapsedTime);
            }
            else
            {
                rotationVelocityAxis.Y = Math.Min(val1: 0.0f,
                                                  rotationVelocityAxis.Y + dampingRotationForce * elapsedTime);
            }
        }

        if (rotationForce.Z    > -0.001f
            && rotationForce.Z < 0.001f)
        {
            if (rotationVelocityAxis.Z > 0)
            {
                rotationVelocityAxis.Z = Math.Max(val1: 0.0f,
                                                  rotationVelocityAxis.Z - dampingRotationForce * elapsedTime);
            }
            else
            {
                rotationVelocityAxis.Z = Math.Min(val1: 0.0f,
                                                  rotationVelocityAxis.Z + dampingRotationForce * elapsedTime);
            }
        }
        ...
        if (rotationVelocityAxis.X    < -0.001f
            || rotationVelocityAxis.X > 0.001f)
        {
        ...
        if (rotationVelocityAxis.Y    < -0.001f
            || rotationVelocityAxis.Y > 0.001f)
        {
            rotationVelocity = rotationVelocity
        ...
        if (rotationVelocityAxis.Z    < -0.001f
            || rotationVelocityAxis.Z > 0.001f)
        {
            rotationVelocity = rotationVelocity
