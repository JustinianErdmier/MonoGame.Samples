...
public class PowerupManager
{
    ...
    private readonly List<LinkedListNode<Powerup>> deletePowerups;

    private readonly GameManager game; // game manager

    // linked list of active powerups
    private readonly LinkedList<Powerup> powerups;

    /// <summary>Create a new powerup manager</summary>
    ...
    /// <summary>Add a new powerup</summary>
    public void Add(Powerup p)
    {
        powerups.AddLast(p);
    }

    /// <summary>Empty powerups list</summary>
    public void Clear()
    {
        powerups.Clear();
    }

    /// <summary>Update all powerups</summary>
    ...
    /// <summary>Draw all powerups</summary>
